          ...
          >
            ...
            <div className="flex flex-none items-center gap-x-4">
              <Link
                ...
                className="hidden rounded-md bg-gray-900 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-white sm:block hover:text-gray-900"
              >
